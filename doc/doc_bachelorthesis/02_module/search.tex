...
\lstset{language=Java, tabsize=4}
\begin{lstlisting}[caption={[Kostenberechnung unter Berücksichtigung des Einflusses] Die Kosten für das Wegstück (PathPiece) werden von der Influence Map (falls verwendet) berechnet.}]
