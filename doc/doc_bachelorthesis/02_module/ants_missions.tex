...
\begin{itemize}
	...
	\item  \textbf{doAnyMove(Ant a):} Für die übergebene Ameise irgendeinen Zug in eine der vier Richtungen bestimmen.
...
Die Pathmission ist eine abstrakte Klasse die von ExploreMission und als anonyme Klasse im CombatTask erweitert wird. Die einzige Funktionalität, die angeboten wird, ist eine Ameise, die dem Konstruktor mit Pfad mitgegeben wird, auf diesem definierten Pfad zu bewegen.
...
\begin{table}[H]
	...
	\begin{minipage}{11cm}
		...
		\textbf{Valid}& Solange der gegnerische Hügel nicht zerstört ist.\\
...
Dieser Modus ist aktiv, wenn zwei oder mehr eigene Ameisen in der Nähe des gegnerischen Hügels sind, der Gegner aber nur eine Ameise zur Verteidigung hat.
...
\begin{table}[H]
	...
	\begin{minipage}{11cm}
		...
		\textbf{Valid}& Solange der eigene Hügel nicht erobert ist.\\
...
Die Sperre wurde gegen Xathis\footnote{Der Sieger-Bot des Wettbewerbs} getestet und sie zeigte nur eine geringe Wirkung. Der Bot von Xathis wartet vor der Sperre, bis er in Überzahl ist und überrumpelt dann unsere Verteidigung. Erstaunlicherweise wird die Sperre von Greentea\footnote{zweitbester Bot}, auch wenn er in Überzahl ist, nicht angegriffen. Gegen diesen Gegner war die Sperre also gutes Mittel zur Verteidigung.
...
Wie bereits im Kapitel Task erwähnt, war nicht alles Programmierte erfolgreich. Hier sind die Missionen aufgelistet, die zu den verworfen oder nicht verwendeten Tasks gehören. (Begründungen siehe Abschnitt \ref{subsec:implementation.Tasks.StupidTasks})
