...
\section{BaseMission}
\label{sec:module.Mission.BaseMission}

Mission

\section{PathMission}
\label{sec:module.Mission.PathMission}

\section{AttackHillMission}
\label{sec:module.Mission.AttackHillMission}

\section{DefendHillMission}
\label{sec:module.Mission.DefendHillMission}

\section{ExploreMission}
\label{sec:module.Mission.ExploreMission}

\section{GatherFoodMission}
\label{sec:module.Mission.GatherFoodMission}
