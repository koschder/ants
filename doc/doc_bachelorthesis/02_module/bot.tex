...
MyBot initialisiert die folgend aufgeführten Tasks; es sind die Tasks, die sich im Lauf der Arbeit bewährt haben. Die detaillierte Beschreibung der Tasks ist im nachfolgenden Kapitel \ref{sec:module.Tasks} zu finden.
