...
\begin{itemize}
\item
\textbf{PathPiece}: Das PathPiece ist ein Interface für Strukturen, die als Suchknoten in der Pfadsuche verwendet werden können. Die implementierende Klassen befinden sich im Searchframework und sind im Kaptiel \ref{sec:module.Suchalgorithmen.Enities} aufgelistet.
\item
