...
\begin{itemize}
\item
\textbf{PathPiece}: PathPiece beschreibt ein Wegstück. Dieses besteht aus einem oder aus mehreren Tiles und wird unteranderem bei den Pfadsuchalgorithmen A* und HPA* verwendet.
\item
