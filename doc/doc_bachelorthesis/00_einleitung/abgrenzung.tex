...
\begin{table}[H]
 ...
 \begin{tabular}{l p{10cm}}
  ...
  MinMax-Algorithmus & Bei den Kampfsituationen wurde versucht, den MinMax-Algorithmus einzubauen, welcher wir bereits im Modul Spieltheorie erarbeitet haben. (Mehr dazu siehe Kapitel \ref{sec:module.StrategieTaktik}) \\
 \end{tabular}
