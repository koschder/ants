...
Nachfolgend sind die Ziele aufgelistet welche wir uns vor der Arbeit gestellt und im Pflichtenheft niedergeschrieben haben. Die farbigen Pfeile zeigt den Erfüllungsgrad an. Ist ein Ziel nicht vollständig erreicht wird in \textit{kursiver} Schrift ein Grund angegeben.
\newline
\newline
\includegraphics[height=3mm]{91_bilder/pfeil-gruen.png}  Vollständig Erfüllt
\newline
\includegraphics[height=3mm]{91_bilder/pfeil-orange.png} Teilweise Erfüllt
\newline
\includegraphics[height=3mm]{91_bilder/pfeil-red.png}  Nicht Erfüllt
\newline
\newline
...
Der Bot identifiziert zur Erfüllung dieser Aufgaben konkrete Ziele, wie z.B.:
	...
	\newline
	\textit{Grund: Keine Zeit für blabal...}
	\item 
